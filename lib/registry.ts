...
export const registry: RegistryItem[] = [
  {
    ...
    description: "Cursor-magnetic button that follows the pointer within a 60px radius, springs back on release. Editorial ease throughout.",
    category: "buttons",
    tags: ["button", "magnetic", "spring", "hover"],
    dependencies: ["framer-motion"],
    sourcePath: "components/foundations/button-magnetic.tsx",
    promptPath: "lib/prompts/button-magnetic.md",
    previewMode: "live",
    ...
    related: ["tilt-card", "theme-toggle", "tabs-pill"],
    api: {
      main: {
        name: "MagneticButton",
        props: [
          { name: "children", type: "ReactNode", description: "Button label or icon rendered inside the pill." },
          { name: "className", type: "string", description: "Extra Tailwind classes appended to the default pill styles.", optional: true },
  ...
  },
  {
    slug: "tilt-card",
    name: "Tilt Card",
    description: "3D pointer-tilt card with a soft radial-gradient cursor glare. Sits between -8° and +8° with spring physics.",
    category: "cards",
    tags: ["card", "3d", "tilt", "hover"],
    dependencies: ["framer-motion"],
    sourcePath: "components/foundations/tilt-card.tsx",
    promptPath: "lib/prompts/tilt-card.md",
    previewMode: "live",
    addedAt: "2026-09-17",
    updatedAt: "2026-09-17",
    isNew: true,
    contributor: { name: "Alok", href: "https://x.com/Alok619308" },
    related: ["button-magnetic", "theme-toggle", "tabs-pill"],
    api: {
      main: {
        name: "TiltCard",
        props: [
          { name: "children", type: "ReactNode", description: "Card contents rendered inside the tilting surface." },
          { name: "className", type: "string", description: "Extra Tailwind classes on the card wrapper.", optional: true },
        ],
      },
    },
  },
  {
    slug: "theme-toggle",
    name: "Theme Toggle",
    description: "Light/Dark pill toggle with a shared layoutId indicator that springs between the two positions.",
    category: "inputs",
    tags: ["toggle", "theme", "pill", "layoutId"],
    dependencies: ["framer-motion"],
    sourcePath: "components/foundations/theme-toggle.tsx",
    promptPath: "lib/prompts/theme-toggle.md",
    previewMode: "live",
    addedAt: "2026-09-17",
    updatedAt: "2026-09-17",
    isNew: true,
    contributor: { name: "Alok", href: "https://x.com/Alok619308" },
    related: ["tabs-pill", "button-magnetic", "tilt-card"],
    api: {
      main: {
        name: "ThemeToggle",
        props: [
          { name: "value", type: "\"light\" | \"dark\"", description: "Currently selected theme.", optional: true },
          { name: "onChange", type: "(v: \"light\" | \"dark\") => void", description: "Fired when the user picks a new theme.", optional: true },
        ],
      },
    },
  },
  {
    slug: "tabs-pill",
    name: "Pill Tabs",
    description: "Pill-style tab bar with a sliding active indicator driven by layoutId. Springs, doesn't jump.",
    category: "layouts",
    tags: ["tabs", "pill", "layoutId", "navigation"],
    dependencies: ["framer-motion"],
    sourcePath: "components/foundations/tabs-pill.tsx",
    promptPath: "lib/prompts/tabs-pill.md",
    previewMode: "live",
    addedAt: "2026-09-17",
    updatedAt: "2026-09-17",
    isNew: true,
    contributor: { name: "Alok", href: "https://x.com/Alok619308" },
    related: ["theme-toggle", "button-magnetic", "tilt-card"],
    api: {
      main: {
        name: "PillTabs",
        props: [
          { name: "tabs", type: "{ id: string; label: string }[]", description: "The tab set to render." },
          { name: "value", type: "string", description: "Currently active tab id.", optional: true },
          { name: "onChange", type: "(id: string) => void", description: "Fired when the user selects a new tab.", optional: true },
        ],
      },
    },
  },
  ...
  },
  {
    ...
    isNew: true,
    contributor: { name: "Alok", href: "https://x.com/Alok619308" },
    related: ["gooey-liquid-feedback-drop","3d-book-carousel-reading-mode","fisheye-chromatic-card-grid"],
  },
  {
  ...
  },
  {
    ...
    dependencies: [],
    sourcePath: "components/foundations/gooey-liquid-feedback-drop.html",
    ...
    isNew: true,
    contributor: { name: "Alok", href: "https://x.com/Alok619308" },
    related: ["stacked-deck-scroll-reveal","3d-book-carousel-reading-mode","fisheye-chromatic-card-grid"],
  },
  {
    ...
    dependencies: [],
    sourcePath: "components/foundations/dot-matrix-cascade-typography.html",
  ...
  },
  {
    ...
    dependencies: [],
    sourcePath: "components/foundations/scrollspy-line-navigation.html",
  ...
  },
  {
    ...
    dependencies: [],
    sourcePath: "components/foundations/isometric-mechanical-keycap.html",
  ...
  },
  {
    ...
    isNew: true,
    contributor: { name: "Alok", href: "https://x.com/Alok619308" },
    related: ["stacked-deck-scroll-reveal","gooey-liquid-feedback-drop","fisheye-chromatic-card-grid"],
  },
  {
