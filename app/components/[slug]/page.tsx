    ...
    <main className="min-h-screen overflow-x-clip bg-white text-[#111827]">
      ...
      <nav className="border-b border-[#E5E7EB]">
        <div className="mx-auto flex max-w-[1100px] items-center justify-between gap-3 px-4 py-4 sm:px-6 sm:py-5">
          <Link
            href="/"
            className="whitespace-nowrap text-[17px] font-semibold tracking-tight text-[#111827] hover:text-[#5C6DFF]"
          >
            Cue<span className="text-[#5C6DFF]">.</span>{" "}
            <span className="text-[13px] font-normal text-[#6B7280]">Kit</span>
          </Link>
          <div className="flex items-center gap-3 text-[13px] sm:gap-6">
            <Link
              href="/"
              className="hidden text-[#6B7280] hover:text-[#111827] sm:inline"
            >
              Components
            </Link>
